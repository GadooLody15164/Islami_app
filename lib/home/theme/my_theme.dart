...
class MyThemeData {
  ...
  static Color secoundryColor = Color(0xFFB7935F).withOpacity(0.57);
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      bodyMedium:
          GoogleFonts.elMessiri(fontWeight: FontWeight.w700, fontSize: 25),
      bodySmall:
          GoogleFonts.elMessiri(fontWeight: FontWeight.w700, fontSize: 20),
    ),
  );
